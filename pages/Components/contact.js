  ...
  return (
    ...
    >
      <input
        ...
        placeholder="Name"
        required
        className="shadow appearance-none border-2 border-gray-500 rounded w-full py-2 px-3 mb-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-green-300"
